...
$(function () {
    function Detector2ViewModel(parameters) {
        ...
        self.modelURL =
            "./plugin/detector2/static/js/graphEffNetB3Model2/model.json";
        ...
        self.onStartup = function () {
            ...
            document
                .getElementById("detector2-tab-start")
                .appendChild(stateField);
            ...
            if (plugin === "detector2") {
                ...
                if (message.type === "snap") {
                    ...
                    self.last_image.onload = function () {
                        ...
                        (async () =>
                            await self.modelPredict(self.last_image))();
                    };
        ...
        self.sendInfoToBackend = function (errorType, confidence) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    console.log(
                        "info about error sent to backend successfully"
                    );
                },
                error: function () {
        ...
        self.modelPredict = async function (theImg) {
            ...
            const smalImg = tf.image.resizeBilinear(
                tfImg,
                self.modelInputShape
            );
